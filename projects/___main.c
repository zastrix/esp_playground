...
#define OLED_SDA_LINE GPIO_NUM_5
#define OLED_SCL_LINE GPIO_NUM_4
...
void app_main(void){
	...
	/*
	 * Initialize the I2C master/slave
	 */
    ...
    xReturned0 = xTaskCreate(   i2c_test_task, 	// pointer to task entry function
							 "i2c_test_task0",	// name of the task
				   2*configMINIMAL_STACK_SIZE,  // stack depth to allocate (number of words)
							         (void*)0,  // params to pass to the task
										   10,  // priority (0 - (configMAX_PRIORITIES-1))
										NULL);  // used to pass a handle to the created task from xTaskCreate f'n.


    xReturned1 = xTaskCreate(   i2c_test_task, 	// pointer to task entry function
							 "i2c_test_task1",	// name of the task
				   2*configMINIMAL_STACK_SIZE,  // stack depth to allocate (number of words)
							         (void*)1,  // params to pass to the task
										   10,  // priority (0 - (configMAX_PRIORITIES-1))
										NULL);  // used to pass a handle to the created task from xTaskCreate f'n.
